...
const DESTINOS  = ['mariajose@matilda.agency', 'johanna@matilda.agency'];
  ...
  try {
    ...
    const html = `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      ...
      <div style="padding:24px;background:#f8fafc;border-left:4px solid #c8264a;">
        ...
        <p style="color:#666;">Responsable: ${liq.responsable || liq.solicitante || '—'}</p>
        <p style="color:#666;">Evento: ${liq.evento || '—'}</p>
        <a href="https://mapa-zeta.vercel.app" style="display:inline-block;margin-top:16px;padding:10px 20px;background:#c8264a;color:#fff;text-decoration:none;border-radius:6px;">Ver en Matilda Hub</a>
      </div>
    ...
    await sendEmail(DESTINOS, `🧾 Liquidación enviada a Financiero: ${liq.presupuesto_nombre || liq.cliente_nombre || ''}`, html);
