...
const DESTINOS  = ['camille@matilda.agency','johanna@matilda.agency'];
  ...
  try {
    ...
    const html = `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      ...
      <div style="padding:24px;background:#f8fafc;border-left:4px solid #2e8b4e;">
        <h2 style="color:#2e8b4e;margin:0 0 12px;">✅ Presupuesto Aprobado</h2>
    ...
    await sendEmail(DESTINOS, `✅ Presupuesto aprobado: ${ppto.nombre || ppto.cliente || ''}`, html);
